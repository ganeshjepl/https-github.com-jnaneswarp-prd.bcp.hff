...
function  addbcp() {
            ...
            $('.error-msg-box').text('');
            /*$(".close addbutton").click(function()
            {
            ...
            {			
                    ...
                    if (stateid === undefined || stateid === null) {
                            ...
                            formdata.append('referral_id', $("#referral_number").val());
                            $.ajax({
                                    type: "POST",
                                    url: site_url + "api/web/v1/ctrl/User/addBcp",
                                    contentType: false,
                                    data: formdata,
                                    processData: false,
                                    success: function (json) {
                                        //alert(json); return false;
                                            $('#bcp_sucess').show().html("Successfully inserted").delay(2500).fadeOut('3000', function () {
...
function  editBcp(id) {
	...
	$.ajax({
        ...
        success: function (json) {
            ...
            $('#referral_number').val(json['response']['userData'][0]['referral_number']);
