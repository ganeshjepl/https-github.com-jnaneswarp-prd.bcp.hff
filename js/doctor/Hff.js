...
/*		
			...
			/*
			 * $(".table-sortable tbody").sortable({ helper: fixHelperModified
			 * }).disableSelection();
			 * 
...
function addRows(val){	
	...
	$.each($("#tab_logic"+val+" tr"), function() {
	...
	// loop through each td and create new elements with
	// name of newid
	$.each($("#tab_logic"+val+" tbody tr:nth(0) td"), function() {
		var cur_td = $(this);
