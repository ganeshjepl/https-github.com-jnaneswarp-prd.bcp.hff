...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo site_url(); ?>css/bcp.css">
        ...
        <script src="<?php echo site_url(); ?>js/bcp.js"></script>	
    ...
    <body class="stylefontinnerpages">
        <nav class="navbar navbar-fixed-top hffgreen">
            <div class="container-fluid">
                <div id="mySidenav" class="sidenav ovflw">
                    ...
                    <hr>
                    <div>
                        <a class="pdbt" href="bcp_landing_screen.html"><img src="<?php echo site_url(); ?>pics/home.png" alt="Lights" class="navimg">&nbsp; Home</a><hr>
                        <a class="pdbt" href="bcp_new_registration.html"><img src="<?php echo site_url(); ?>pics/form_white.png" alt="Lights" class="navimg">&nbsp;New Patient Registration</a><hr>
                        <a class="pdbt" href="bcp_medical_records.html"><img src="<?php echo site_url(); ?>pics/book_white.png" alt="Nature" class="navimg">&nbsp;Medical Records</a><hr>
                        <a class="pdbt" href="bcp_health_incident.html"><img src="<?php echo site_url(); ?>pics/stethoscope_white.png" alt="Fjords" class="navimg">&nbsp;Health Incident</a><hr>
                        <a class="pdbt" href="bcp_followup_incident.html"><img src="<?php echo site_url(); ?>pics/doctor_white.png" alt="Nature" class="navimg">&nbsp;FollowUp Incidents</a><hr>
                        <a class="pdbt" href="bcp_emergency_screen.html"><img src="<?php echo site_url(); ?>pics/plus_white.png" alt="Fjords" class="navimg">&nbsp;Emergency</a><hr>
                        <a class="pdbt" href="bcp_settings_screen.html"><img src="<?php echo site_url(); ?>pics/settings_white.png" alt="Fjords" class="navimg">&nbsp;Settings</a><hr>
                        <a class="pdbt" href="<?php echo site_url(); ?>login_cntrl/logout"><img src="<?php echo site_url(); ?>pics/logout.png" alt="Fjords" class="navimg">&nbsp;Logout</a><hr>
                    </div>
                </div>
                <span class="fltleft 3nav"  style=" width:5%; height:auto; font-size:35px;" onclick="openNav()">&#9776;</span>
                <div align="center" class="paddtop">
                    <p class=" hffgreen">
                        <img src="<?php echo site_url(); ?>pics/form_white.png" alt="Nature" class="widt2 ">
                        &nbsp;New Patient Registration</p>
                </div>
