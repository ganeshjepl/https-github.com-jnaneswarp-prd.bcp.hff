    ...
    <div class="panel-group" id="accordion2" role="tablist" aria-multiselectable="true">
		...
		<div class="panel panel-default">
            ...
            <div class="panel-heading" role="tab" id="headingzero">
                <h4 class="panel-title title-icon">
                       <i class="fa fa-file-text" aria-hidden="true"></i>BCP Details
      ...
      <tr>
		...
		<tr>
			<th class="bodtop">Current Date :</th>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title title-icon">
                        <i class="fa fa-file-text" aria-hidden="true"></i>Patient Details
      ...
      <tr>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading" role="tab" id="headingTwo">
				...
				<h4 class="panel-title title-icon">
                        <i class="fa fa-file-text" aria-hidden="true"></i>Medical Notes 
                </h4>
            ...
            <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
                <div class="panel-body">
                    <div class="w3-container w3-margin-bottom note-box">
        ...
        <div class="col-md-12 col-sm-6 table-responsive nopad">
		 ...
		 <div class="panel panel-default">
            ...
            <div class="panel-heading" role="tab" id="headingfour">
                <h4 class="panel-title title-icon">
                        <i class="fa fa-file-text" aria-hidden="true"></i>Medicine
				...
				<table class="table table-bordered table-hover table-sortable"
					...
					<tbody ng-app="medicines_catalog_app" ng-controller="country">
						<tr id='addr0' data-id="0" class="hidden" >
							...
							<td data-name="del">
<button name="del0" class='btn btn-danger glyphicon glyphicon-remove row-remove doc-del-btn'  onclick="doctor.deleteRow('prescription_saving_doc',this.id);"></button>
							</td>
...
<!--       <button id="submit" type="submit" class="w3-left w3-teal  w3-btn" data-dismiss="modal">Submit</button>
       ...
       <!--  <a class="w3-left w3-teal w3-section w3-btn" href="doc_send_prescription.html">Submit</a>
        <a  class="w3-left w3-teal w3-section w3-btn marg10" href="doc_send_prescription.html">Send By SMS</a> -->
          ...
          <button type="button" onclick="$('#presc_button_<?php echo $presc_details['id']; ?>').attr('disabled',false);" class="w3-left w3-btn w3-red " data-dismiss="modal">Close</button>
        </div>
      </div>
      <!--Add new modal end -->
</div>
